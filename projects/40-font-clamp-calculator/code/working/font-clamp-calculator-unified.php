...
?>
        ...
        private function render_unified_javascript()
        {
            ?>
                <script id="font-clamp-unified-script">
                    ...
                    /**
                     * Font Clamp Advanced Features Controller
                     */
                    class FontClampAdvanced {
                        ...
                        constructor() {
                            ...
                            this.initState = {
                                ...
                                dataReady: false, // Why: Can't calculate sizes without font clamp data  
    ...
    `;
                        ...
                        populateSettings() {
                            ...
                            if (!data) {
                                console.error('❌ No font clamp data available!');
                                return;
                            }
